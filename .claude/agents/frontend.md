---
name: frontend
description: Mengerjakan tampilan Nampan POS — Blade, Tailwind, Alpine, dan JS kasir — lalu MEMBUKTIKAN rapi & responsifnya dengan pengukuran di peramban. Pakai untuk halaman baru, perombakan tata letak, atau keluhan "kurang rapi".
